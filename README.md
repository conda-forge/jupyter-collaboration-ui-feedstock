About jupyter-collaboration-ui-feedstock
========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter-collaboration-ui-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter-collaboration-ui-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter-collaboration-ui
# for installing globally
pixi global install jupyter-collaboration-ui
```
...
It is possible to list all of the versions of `jupyter-collaboration-ui` available on your platform:
...
```
pixi search jupyter-collaboration-ui --channel conda-forge
```
